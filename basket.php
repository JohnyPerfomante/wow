    ...
    <div class="container">
        <form action="#" class="basket-form">
            <div class="order-summary" style="margin-top: 20px;">
                <h1 class="title-basket">Оформлення замовлення</h1>
                <div id="cart-items">
                </div>
                <p class="text-basket">Доставка кур'єром: <span id="delivery-cost">60</span> грн</p>
                <p class="text-basket">Упаковка: <span id="packaging-cost">5</span> грн</p>
                <h2 class="title-basket">Всього: <span id="total-cost">0</span> грн</h2>
            </div>
            <div class="delivery-form">
                <h2 class="title-basket">Доставка</h2>
                ...
                <div class="form-group">
                    <label for="quantity">Кількість наборів паличок</label>
                ...
                <div class="button" id="submit-order">Оформити замовлення</div>
            </div>
        </form>
    </div>
